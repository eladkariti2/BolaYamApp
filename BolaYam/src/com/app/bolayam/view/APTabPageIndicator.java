...
public class APTabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private final APIcsLinearLayout mTabLayout;
    ...
    public APTabPageIndicator(Context context) {
        this(context, null);
    }

    public APTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        setHorizontalScrollBarEnabled(false);
        
        initCustomStyleAttribute(attrs);
        
        mTabLayout = new APIcsLinearLayout(context, mCustomStyleAttribute == -1 ? R.attr.vpiDefaultTabPageIndicatorStyle : mCustomStyleAttribute);
...
//        }
    ...
    private class TabView extends RelativeLayout {
        ...
        public TabView(Context context) {
            ...
            LinearLayout.LayoutParams imageParams = new LinearLayout.LayoutParams(OSUtil.convertDPToPixels(20),OSUtil.convertDPToPixels(15));
            imageParams.setMargins(OSUtil.convertDPToPixels(10),0, OSUtil.convertDPToPixels(10) , 0);
            
            
            LinearLayout ly = new LinearLayout(context);
            LayoutParams lyParams = new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
            lyParams.addRule(CENTER_IN_PARENT);
            ly.setLayoutParams(lyParams);
            
         
            LinearLayout.LayoutParams textParams = new  LinearLayout.LayoutParams(WRAP_CONTENT,WRAP_CONTENT);
//            textParams.addRule(BELOW,mImage.getId());
//            textParams.addRule(CENTER_HORIZONTAL);
            
            mTitle.setLayoutParams(textParams);
            mImage.setLayoutParams(imageParams);
          
            mTitle.setTextColor(context.getResources().getColor(R.drawable.tab_text_color_selector));
