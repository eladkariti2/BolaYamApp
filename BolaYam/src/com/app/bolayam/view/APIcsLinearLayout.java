 ...
 */
public class APIcsLinearLayout extends LinearLayout {
    ...
    public APIcsLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        
        setDividerDrawable(a.getDrawable(APIcsLinearLayout.LL_DIVIDER));
